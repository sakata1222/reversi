...
public class MctsReversiGame implements IMctsGame<MctsReversiMove> {
  ...
  @Override
  public List<MctsReversiMove> puttableMoves(GamePlayerColor color) {
  ...
  @Override
  public void put(MctsReversiMove move, GamePlayerColor childColor) {
